...
import { Button, Checkbox, ConfigProvider, DatePicker, Form, Input, message, Radio, Select, Tooltip } from 'antd';
...
export const TripForm = () => {
	...
	const [additionalColumns, setAdditionalColumns] = useState<Record<string, string>>({});
